          ...
          <div>
            ...
            {voicesMeta && (
              <p className="mt-2 text-[11px] text-muted-foreground/75 leading-relaxed">
                Provider: <span className="text-foreground/85">{voicesMeta.modelLabel}</span>
                {voicesMeta.pricePerMinUsd > 0 && (
                  <> · ${voicesMeta.pricePerMinUsd.toFixed(3)}/min</>
                )}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {!voicesMeta ? (
              ...
              <>
                ...
                <div className="max-h-[220px] overflow-y-auto rounded-md border border-white/[0.06] bg-white/[0.015] p-1.5 space-y-1">
                  {filteredVoices.map((v) => {
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          'cursor-pointer rounded-lg px-3 py-2 flex items-center gap-3 transition-all',
                          selected
                      ...
                      >
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2">
                            <span className="font-display text-base tracking-tight text-foreground/95">
                              {v.label}
                            </span>
                            {v.gender && <Badge>{v.gender}</Badge>}
                            {selected && (
                              <span className="text-[9px] uppercase tracking-[0.18em] text-aurora-1">
                                selected
                              </span>
                            )}
                          </div>
                        ...
                        <button
                          ...
                          className="shrink-0 h-7 w-7 rounded-full border border-white/[0.08] bg-white/[0.04] hover:bg-white/[0.08] flex items-center justify-center text-foreground/85"
      ...
      {result && (
        <Card className="p-5 mt-6">
          <div className="flex items-center justify-between mb-3">
            <div className="text-[10px] uppercase tracking-[0.22em] text-aurora-1">
              Rendered
            </div>
